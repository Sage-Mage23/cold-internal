...
public:
	FText DisplayName()
	{
		return *(FText*)(std::uintptr_t(this) + Offsets::DisplayName);
	}
};
...
public:
	...
	{
		return *(float*)(this + Offsets::GravityScale);
	}
	...
	{
		return *(UFortWeaponItemDefinition**)(this + 0x5e8);
	}
...
public:
	...
	TArray<UObject*> GetAllActorsOfClass1(UObject* WorldContextObject, UObject* ActorClass)
	{
		static UObject* Function = 0;
		if (!Function)
		{
			auto EncryptedFunction = Encrypt(L"GameplayStatics.GetAllActorsOfClass");
			Function = FindObjectSingle<UObject*>(EncryptedFunction.decrypt()); EncryptedFunction.clear();
		}
	...
	auto GetAllActorsOfClass( UObject* WorldContextObject, UObject* ActorClass, TArray<Type*>* OutActors) -> void
	{
		static UObject* Function = nullptr;
		if (!Function)
		{
			Function = FindObjectSingle<UObject*>(L"GameplayStatics.GetAllActorsOfClass");
		}
...
public:
	...
	{
		return *(TArray<AActor*>*)(this + Offsets::Actors); //0xA0
	}
};
